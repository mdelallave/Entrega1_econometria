...
D = 1; % Número de diferencias de nuestro modelo

% Tipo de cambio EURO/US
check_eurous = checkArima(leurous,pp,D,qq,T);
[M,I] = min(check_eurous(:)); % I: índice que contiene el valor más pequeño
[p, q] = ind2sub(size(check_eurous),I); % Coordenadas del valor más pequeño
